...
<head>
    ...
    <link rel="stylesheet" href="{{asset('js/DataTablesNuevo/datatables.min.css')}}">
    ...
    <script type="text/javascript" src="{{ asset('js/jquery-ui/js/jquery-ui-1.10.4.min.js') }}"></script>
